...
class JobGridFromRD extends Component {
    state = {
        loading: true,
        jobs: null
    }
    ...
    componentDidMount() {
        database.ref('/users/' + this.props.userId + '/recommendation/').once('value')
            .then(snapshot => {
...
export default connect(mapStateToProps)(withStyles(styles)(JobGridFromRD));
