...
const JobCard = props => {
    ...
    useEffect(() => {
        if (didMountRef.current) {
            ...
            const timer = setTimeout(() => {
                if (favorite) {
                    database.ref('/users/' + props.userId + '/favorite/' + props.id).set(
                        {
                            type: props.type,
                ...
                if (applied) {
                    database.ref('users/' + props.userId + '/history/' + props.id).set(
                        {
                            type: props.type,
                            created_at:props.createdAt,
                            company: props.company,
    ...
    }, [favorite, applied, props.type, props.createdAt, props.userId, props.id, props.company,props.companyLogo, props.description]);
